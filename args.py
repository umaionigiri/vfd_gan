...
class Args():
    def __init__(self):
        ...
        self.parser.add_argument('--ep', default=10, type=int, help='epochs for training')
        self.parser.add_argument('--device', type=str, default='gpu', help='Device: gpu | cpu')

        # Path
        TR_PLIST = "/mnt/fs2/2018/ohshiro/vfd/lists/semi_full_train_path_list.txt"
        TS_PLIST = "/mnt/fs2/2018/ohshiro/vfd/lists/semi_full_test_path_list.txt"
        ...
        self.parser.add_argument('--batchsize', default=4, type=int, help='input batch size')
